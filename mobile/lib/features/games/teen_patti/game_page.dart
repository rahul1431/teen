...
class _TeenPattiGamePageState extends State<TeenPattiGamePage>
  ...
  static const _tableSeats = {
    ...
    3: [(0.08, 0.65), (0.15, 0.20), (0.85, 0.20)], // bottom-left, top-left, top-right
    4: [(0.08, 0.65), (0.15, 0.20), (0.85, 0.20), (0.92, 0.65)], // bottom-left, top-left, top-right, bottom-right
    5: [(0.08, 0.68), (0.08, 0.30), (0.28, 0.20), (0.72, 0.20), (0.92, 0.30)], // bottom-left, mid-left, top-left, top-right, mid-right
  };
  ...
  // Fixed seat positions for opponents (x, y) relative to table oval
  static const List<(double, double)> _fixedOpponentSeats = [
    (0.15, 0.20), // top-left
    (0.85, 0.20), // top-right
    (0.08, 0.65), // bottom-left
    (0.92, 0.65), // bottom-right
  ];
  ...
  void didChangeDependencies() {
    ...
    precacheImage(const AssetImage('assets/images/avatar_nairobi.png'), context);
  ...
  String? get _effectivePrivateCode {
    ...
    return gs?['private_code']?.toString() ?? widget.initialData?['private_code']?.toString();
  }
  ...
  Future<void> _init() async {
    ...
    _gameStateSub = _socket.on(SocketEvents.gameStateUpdate).listen((data) {
      ...
      final Map<String, dynamic> gs = {...Map<String, dynamic>.from(inner), 'players': players};
      _gsNotifier.value = gs;
                  ...
                  return Stack(children: [
                    ...
                    Positioned(
                      ...
                      child: _HostessWidget(
                        ...
                        onTipTap: () => setState(() => _showTipMenu = !_showTipMenu),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [5, 10, 20, 50].map((amount) {
                                Color chipColor;
                                switch (amount) {
                                  case 5: chipColor = const Color(0xFF1976D2); break;
                                  case 10: chipColor = const Color(0xFF388E3C); break;
                                  case 20: chipColor = const Color(0xFFD32F2F); break;
                                  default: chipColor = const Color(0xFFFBC02D);
                                }
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: RadialGradient(
                                        colors: [
                                          ...
                                          chipColor,
                                          Color.lerp(chipColor, Colors.black, 0.3)!,
                                        ],
                                      ...
                                      boxShadow: [
                                        BoxShadow(color: chipColor.withOpacity(0.4), blurRadius: 2, offset: const Offset(0, 0.5))
                                      ],
                                    ),
                                    child: Container(
                                      width: 17,
                                      ...
                                      child: Text(
                                        ...
                                        style: const TextStyle(
                                          ...
                                          shadows: [
                                            Shadow(color: Colors.black54, blurRadius: 1, offset: Offset(0, 0.5))
                                          ],
                                        ),
                                      ),
                                    ),
              ...
              Positioned(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFFD4AF37).withOpacity(0.08), // soft gold aura
                        Colors.transparent,
                      ],
                    ),
                  ),
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  ...
                  blurRadius: 36, spreadRadius: 8, offset: const Offset(0, 12)),
            ],
          ),
          child: Container(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  'TEEN PATTI',
                  style: TextStyle(
                    color: const Color(0xFF7E1825).withOpacity(0.35),
                    fontSize: tw * 0.08,
                    fontWeight: FontWeight.w900,
                    letterSpacing: 8,
                    shadows: [
  ...
  Widget _positionedInviteSeat(
    (double, double) frac, double w, double h,
    double tl, double tt, double tw, double th,
  ) {
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color(0xFFFFD43F).withOpacity(0.6),
                    width: 1.5,
                  ),
                ),
                child: const Icon(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFFFD43F).withOpacity(0.15),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: const Color(0xFFFFD43F).withOpacity(0.4), width: 0.8),
                ),
                child: const Text(
                  'INVITE',
                  style: TextStyle(
  ...
  Widget _positionedSeat(
    ...
    return Positioned(
      ...
      left: sl, top: st, width: sw,
      child: RepaintBoundary(child: _buildSeatWidget(p, gs, sw, fracX: frac.$1)),
    );
  }
  ...
  Widget _buildSeatWidget(Map<String, dynamic> p, Map<String, dynamic>? gs, double sw, {bool isMe = false, double fracX = 0.5}) {
      ...
      children: [
          ...
          children: [
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isMe 
                      ...
                      : (isTurn ? const Color(0xFF2ECC71) : const Color(0xFFD4AF37).withOpacity(0.45)),
                  ...
                  ? ValueListenableBuilder<int>(
                      ...
                      builder: (_, secs, __) => CircularProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation(
                            secs <= 5 ? const Color(0xFFE53935) : const Color(0xFF2ECC71)),
                      ),
                    )
                  : null,
            ),
            ...
            ValueListenableBuilder<List<_Reaction>>(
              ...
              builder: (_, reactions, child) {
                final myRx = reactions.where((r) => r.userId == uid).firstOrNull;
                if (myRx == null) return child!;
                
                // Apply animation effect based on emoji
                final emoji = myRx.emoji;
                if (emoji == '👏' || emoji.contains('💰')) {
                  return child!.animate(onPlay: (c) => c.repeat(max: 3))
                      .scale(begin: const Offset(1.0, 1.0), end: const Offset(1.2, 1.2), duration: 250.ms, curve: Curves.easeOut)
                      .then()
                      .scale(begin: const Offset(1.2, 1.2), end: const Offset(1.0, 1.0), duration: 200.ms, curve: Curves.easeIn);
                } else if (emoji == '😂' || emoji == '🔥' || emoji == '😎') {
                  return child!.animate(onPlay: (c) => c.repeat(max: 2))
                      .moveY(begin: 0, end: -8, duration: 200.ms, curve: Curves.easeOut)
                      .then()
                      .moveY(begin: -8, end: 0, duration: 150.ms, curve: Curves.easeIn);
                } else if (emoji == '😘' || emoji == '😮' || emoji == '😭') {
              ...
              Positioned.fill(
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(color: const Color(0xFFE53935).withOpacity(0.8), width: 1.5),
                  ),
                  alignment: Alignment.center,
                  child: Text(
                    'PACK',
                    style: TextStyle(
                      ...
                      letterSpacing: 1.0,
                      shadows: [
                        Shadow(color: const Color(0xFFD32F2F).withOpacity(0.6), blurRadius: 4)
                      ],
                    ),
                  ),
                ),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(
                      ...
                      letterSpacing: 0.6,
                      shadows: [
                        Shadow(color: Colors.black38, blurRadius: 1, offset: Offset(0, 0.5))
                      ],
                    ),
                  ),
                ),
            ...
            if (isMe)
              Positioned(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.card_giftcard, size: badgeD * 0.65, color: Colors.white),
                ),
              ),
          ],
        ),
        ...
        if (chips != null) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFF0F1626).withOpacity(0.85),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
    ...
    final cards = _opponentCardBacks(isFolded: isFolded, isSeen: p['is_seen'] ?? p['isSeen'] ?? false);
  ...
  Widget _buildUserCards(
    ...
    if (_isDealingCards) return const SizedBox.shrink(); // Hide cards during dealing

    final actionBarH = (60 * _ls).clamp(50.0, 80.0);
    final cardsBottom = tt + th - actionBarH + 4; // moved down as player avatar is hidden
  ...
  Offset _getSeatCoordinates(
      String userId, double w, double h, double tl, double tt, double tw, double th) {
    if (userId == _myUserId) {
    ...
    final gs = _gsNotifier.value;
    final players = (gs?['players'] as List? ?? []);
    final activeOpponents = players.where((p) => (p['userId'] ?? p['user_id']) != _myUserId).toList();
    
    int seatIndex = activeOpponents.indexWhere((p) => (p['userId'] ?? p['user_id']) == userId);
    if (seatIndex == -1) {
      // Fallback
  ...
  Widget _buildUserSeat(
      Map<String, dynamic>? gs, double w, double h, double tl, double tt, double tw, double th) {
  ...
  Widget _buildPotChip(Map<String, dynamic>? gs, double w, double tt, double tw, double th) {
    ...
    return Positioned(
      left: (w - _rightPanelW) / 2 - chipW / 2, top: tt + potY,
      child: Container(
        width: chipW,
        padding: EdgeInsets.symmetric(
      ...
      child: RepaintBoundary(
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: const Color(0xFF0F1626).withOpacity(0.72),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(color: const Color(0xFFD4AF37).withOpacity(0.4), width: 1.0)),
            child: Text(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: secs <= 5
                              ...
                              : [const Color(0xFF8B0F1E), const Color(0xFF5A0A14)],
                          begin: Alignment.topCenter,
                          end: Alignment.bottomCenter,
                        ),
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: secs <= 5 ? const Color(0xFFFF8A80) : const Color(0xFFFF8A80).withOpacity(0.4),
                          width: 1.2,
                        ),
                        boxShadow: [
                          BoxShadow(
                            color: (secs <= 5 ? const Color(0xFFE53935) : const Color(0xFF8B0F1E)).withOpacity(0.4),
                            blurRadius: 8,
                            spreadRadius: 1,
                          ),
                        ],
  ...
  // ⑩ Floating reactions (Floating directly from the seat that sent them!)
  Widget _buildReactions(List<_Reaction> reactions, double w, double h, double tl, double tt, double tw, double th) {
              ...
              return Row(
                ...
                children: [
                  ...
                  if (_isSeen && activeCount > 2) ...[
                    _actionBtn('Side Show', AppColors.red, () => _guardedAction('sideshow'), width: btnSecond),
                    SizedBox(width: gap),
                  ] else if (activeCount == 2) ...[
                    _actionBtn('Show', AppColors.red, () => _guardedAction('show'), width: btnSecond),
                    SizedBox(width: gap),
                  ],
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: const Color(0xFFD4AF37).withOpacity(0.65), width: 1.2),
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text('🪙', style: TextStyle(fontSize: (13 * _ls).clamp(11.0, 15.0))),
                        const SizedBox(width: 4),
                        Text(
                  ...
                  _actionBtn(label, AppColors.red,
        ...
        Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(24),
              border: Border.all(
                  color: won ? const Color(0xFFFFD700) : const Color(0xFFFF4D4D), width: 2.5),
              boxShadow: [
                BoxShadow(
                    color: (won ? const Color(0xFFFFD700) : const Color(0xFFFF4D4D)).withOpacity(0.35),
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: won ? const Color(0xFFFFD700) : const Color(0xFFFF4D4D),
                  letterSpacing: 1.0,
                  shadows: [Shadow(
                      color: (won ? const Color(0xFFFFD700) : const Color(0xFFFF4D4D)).withOpacity(0.5),
                      blurRadius: 12)],
                ),
              ).animate().scale(
              ...
              Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: won ? const Color(0xFFFFD700) : Colors.white.withOpacity(0.12),
                    foregroundColor: won ? Colors.black : Colors.white,
                    shadowColor: won ? const Color(0xFFFFD700).withOpacity(0.4) : Colors.transparent,
                    elevation: won ? 8 : 0,
                    shape: RoundedRectangleBorder(
                        side: won ? BorderSide.none : BorderSide(color: Colors.white.withOpacity(0.3), width: 1.0),
                        borderRadius: BorderRadius.circular(20)),
                    padding: const EdgeInsets.symmetric(
                        horizontal: 20, vertical: 12),
                  ),
  ...
  Widget _opponentCardBacks({bool isFolded = false, bool isSeen = false}) {
    if (_isDealingCards) return SizedBox(height: (24 * _ls).clamp(18.0, 32.0) + 4);
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFF0F1626).withOpacity(0.72),
            shape: BoxShape.circle,
            border: Border.all(color: const Color(0xFFD4AF37).withOpacity(0.85), width: 1.2),
            boxShadow: [
              BoxShadow(
                  color: const Color(0xFFD4AF37).withOpacity(0.18), blurRadius: 8,
                  spreadRadius: 1),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: btnColors[1].withOpacity(0.45), blurRadius: 10, spreadRadius: 1),
        ...
        child: amountText != null
            ? Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('🪙', style: TextStyle(fontSize: (10.5 * _ls).clamp(8.5, 12.5))),
            ...
            : Text(label,
                style: TextStyle(
                    ...
                    letterSpacing: 0.5,
                    shadows: const [Shadow(color: Colors.black54, blurRadius: 3, offset: Offset(0, 1.5))])),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            begin: Alignment.topCenter, end: Alignment.bottomCenter,
            colors: [Color(0xFF00E5FF), Color(0xFF00838F)], // Sleek cyan gradient
          ),
  ...
  void _triggerCardDealingAnimation(Map<String, dynamic> gs) {
    ...
    final players = (gs['players'] as List? ?? []);
    final activePlayers = players.where((p) => p['status'] == 'active' || p['status'] == 'playing').toList();
    if (activePlayers.isEmpty) return;
    
    final handId = gs['hand_id']?.toString() ?? gs['current_hand_id']?.toString();
...
class _HostessWidget extends StatefulWidget {
  ...
  const _HostessWidget({required this.tipTrigger, required this.onTipTap, required this.onInviteTap, required this.isDealing});
  @override
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              Container(
                ...
                child: Image.asset(
                  ...
                  .scale(begin: const Offset(1.0, 1.0), end: const Offset(1.2, 1.2), duration: 200.ms, curve: Curves.easeOut)
                  .then()
                  .scale(begin: const Offset(1.2, 1.2), end: const Offset(1.0, 1.0), duration: 150.ms, curve: Curves.easeIn),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFFFFD43F).withOpacity(0.4),
                          blurRadius: 8,
                          spreadRadius: 1,
                          offset: const Offset(0, 2),
                        )
                    ...
                    child: const Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.person_add_alt_1_rounded, color: Colors.black87, size: 11),
                        Text(
                          'INVITE',
                          style: TextStyle(color: Colors.black87, fontSize: 6.5, fontWeight: FontWeight.w900, letterSpacing: 0.2),
                        ),
                      ],
                    ),
                  ),
    ...
    if (widget.isDealing) {
      hostessColumn = hostessColumn
          ...
          .scale(begin: const Offset(1.0, 1.0), end: const Offset(1.08, 1.08), duration: 125.ms, curve: Curves.easeInOut)
          .rotate(begin: -0.04, end: 0.04, duration: 125.ms, curve: Curves.easeInOut);
    } else {
      hostessColumn = hostessColumn
          .animate(controller: _idleController)
          .moveY(begin: 0, end: -6, duration: 1400.ms, curve: Curves.easeInOut)
          .scale(begin: const Offset(0.97, 0.97), end: const Offset(1.03, 1.03), duration: 1400.ms, curve: Curves.easeInOut)
            ...
            ..._particles.map((p) {
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  final progress = ((_tipController.value * 1500 - p.delay) / 1000.0).clamp(0.0, 1.0);
...
class _TipParticle {
  ...
  _TipParticle({required this.dx, required this.dy, required this.icon, required this.scale, required this.delay});
}
...
class _FlyingCard {
  ...
  final int delayMs;
  final int index;
  _FlyingCard({required this.start, required this.end, required this.delayMs, required this.index});
}
...
class _FlyingCardWidgetState extends State<_FlyingCardWidget>
  ...
  void initState() {
    ...
    _rotationAnimation = Tween<double>(
      begin: 0.0,
      end: widget.flyingCard.index * 0.10 - 0.05, // minor fan angle rotation at target
