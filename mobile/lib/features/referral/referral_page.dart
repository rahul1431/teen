...
class _ReferralPageState extends State<ReferralPage>
  ...
  Map<String, dynamic> get _stats =>
      (_data?['stats'] as Map?)?.cast<String, dynamic>() ?? {};
        ...
        child: Column(
          ...
          children: [
            ...
            _step(
                ...
                'Friend Registers',
                'Friend signs up using your code & downloads the app',
                AppColors.purple),
            _stepConnector(),
  ...
  Widget _step(
          String num, IconData icon, String title, String sub, Color color) =>
      Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
    ...
    return Column(
      ...
      children: [
        ...
        if (count == 0)
          ...
          ...List.generate(count,
              (i) => _buildReferralTile(_referrals[i] as Map<String, dynamic>)),
      ],
    );
  }
  ...
  Widget _buildReferralTile(Map<String, dynamic> r) {
    ...
    final createdAt =
        r['created_at'] != null ? DateTime.tryParse(r['created_at']) : null;
